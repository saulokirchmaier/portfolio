...
function AboutMe() {
  return (
    <div className="Content AboutMe">
      ...
      <p>Desenvolvedor Web Full-Stack em formação pela <a href="https://www.betrybe.com/" target="_blanck">Trybe</a>, sembre busco caminhos que me agregem valor e as pessoas ao meu redor, e que ajudem a mudar a forma que enchergamos o mundo. Quero contribir para o desenvolvimento de sistemas que transformem o dia-dia das pessoas.</p>
    </div>
  );
}
