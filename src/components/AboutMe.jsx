...
function AboutMe() {
  return (
    <div className="Content AboutMe">
      ...
      <p>Desenvolvedor Web Full-Stack em formação pela <a href="https://www.betrybe.com/" target="_blanck">Trybe</a>, sempre busco caminhos que agregam valor a mim e as pessoas ao meu redor, e que ajudam a mudar a forma que enchergamos o mundo. Quero contribir para o desenvolvimento de sistemas que transformem o dia-dia das pessoas.</p>
    </div>
  );
}
